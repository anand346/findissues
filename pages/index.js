...
export default function Home() {
  return (
    <>
        <div className = {`${styles.landing_main} overflow-auto w-[100%] pt-[40px] md:pt-0 md:w-[54%] landing_main h-full flex flex-col items-start justify-start`}>
          <div >
            ...
            <p className = "pl-3 pr-3 md:p-0 md:ml-[90px] md:mr-[90px] text-main_yellow text-[18px] md:text-[22px] mb-[30px] text-justify ">Find Most Recent and Unassigned Issues Here!</p>
            <p className = "text-[14px] md:text-[18px] pl-3 pr-3 md:p-0 md:ml-[90px] md:mr-[90px] text-main_primary italic leading-loose mb-[50px] text-justify">Find issues lets you find <b>most recently created issues</b> on GitHub that are <b>not assigned</b> to anyone according to your development language with its advance search technique.</p>
          </div>
