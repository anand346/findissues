          ...
          <>
            ...
            <div className="w-[100%] sm:w-[95%] flex justify-between items-center" id="issues-nav">
              ...
              <div className="relative inline-block text-left" ref={dropdownRef}>
                ...
                {isOpen && (
                  <div
                    className={`origin-top-right absolute right-0 mt-1 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 bg-${theme}_main_secondary`}
                    role="menu"
