...
export default function LeftSidebar() {
  ...
  return (
    <>
      <div
        className={`${styles.left_sidebar} overflow-auto hidden md:block  left_sidebar  h-max-screen md:p-8 p-3 w-[100%] md:w-[23%] md:border-r-2 border-${theme}_main_secondary h-full `}
      >
        <div className="left_sidebar_content flex flex-col justify-start items-start">
          <div className="basic_search w-full flex flex-col items-start justify-start mb-4">
            <p className={`basic_search_title w-full text-${theme}_main_yellow font-semibold italic text-[16px] lg:text-[18px]`}>
              Basic Search
            </p>
            <div
          ...
          <div className="advance_search w-full flex flex-col items-start justify-start mb-4">
            <p className={`advance_search_title flex w-full justify-start items-center  text-${theme}_main_yellow font-semibold italic text-[18px]`}>
              Tags
            </p>
            <div
                    ...
                    <div
                      className={` ${
                        tag.query === router?.query?.lang
                          ? `bg-${theme}_main_secondary`
                          : ""
                      } cursor-pointer mr-2 lang_name truncate px-3 py-1 text-center border-${theme}_main_primary border-[2px] rounded-[5px] italic font-semibold text-${theme}_main_primary text-[12px] lg:text-[14px] transition-all transform md:hover:scale-105 md:hover:border-dashed md:hover:text-${theme}_main_yellow md:hover:border-${theme}_main_yellow duration-300`}
                    >
                      {tag.tag_name}
                    </div>
                  </Link>
          ...
          <div className={"w-full flex items-start justify-start flex-wrap "}>
            <p className={`flex w-full justify-start items-center  text-${theme}_main_yellow font-semibold italic text-[18px] mr-3`}>
              Active Repo
            </p>
            <div
              className={
