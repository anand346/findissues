...
export default function LeftSidebar() {
  ...
  return (
    <>
      <div
        className={`${styles.left_sidebar} overflow-auto  left_sidebar  h-max-screen md:p-8 p-3 w-[100%] md:w-[23%] md:border-r-2 border-main_secondary h-full `}
      >
            ...
            <div className="advance_search_content  w-full flex flex-wrap items-start justify-start space-y-3 ">
              <div className=" filter_btn flex h-8 first:mt-3 mr-2">
                <span className="inline-flex items-center px-2 text-main_primary bg-transparent border border-t-[2px] border-l-[2px] border-b-[2px] border-main_primary rounded-l-[20px] ">
                  <svg
                    ...
                    height="16.929"
                    className="h-3"
                    viewBox="0 0 14.795 16.929"
                  >
                    <path
                      id="Icon_open-fork"
                      data-name="Icon open-fork"
                      d="M3.17,0A3.166,3.166,0,0,0,0,3.17,3.132,3.132,0,0,0,2.114,6.15v4.629A3.112,3.112,0,0,0,0,13.759a3.17,3.17,0,0,0,6.341,0,3.109,3.109,0,0,0-1.775-2.832,1.049,1.049,0,0,1,.719-.338H9.511a3.193,3.193,0,0,0,3.17-3.17V6.171a3.112,3.112,0,0,0,2.113-2.98,3.17,3.17,0,1,0-6.341,0,3.132,3.132,0,0,0,2.114,2.98V7.418A1.046,1.046,0,0,1,9.511,8.475H5.284a3.467,3.467,0,0,0-1.057.19V6.15A3.112,3.112,0,0,0,6.341,3.17,3.166,3.166,0,0,0,3.17,0Z"
                      fill="#1b9c85"
                    />
                  </svg>
                </span>
                <input
                  type="text"
                  id="website-admin"
                  className=" rounded-r-[20px] w-[65px] bg-transparent border border-main_primary text-main_primary border-t-[2px] border-r-[2px] border-b-[2px] focus:outline-0 focus:ring-0 focus:border-main_primary placeholder:italic"
                  placeholder="Forks"
                />
              </div>
              <div className=" filter_btn flex h-8 first:mt-3 mr-2">
                <span className="inline-flex items-center px-2 text-main_primary bg-transparent border border-t-[2px] border-l-[2px] border-b-[2px] border-main_primary rounded-l-[20px] ">
                  <svg
                    ...
                    height="14.999"
                    className="h-3"
                    viewBox="0 0 16.153 14.999"
                  >
                    <path
                      id="Icon_ionic-ios-star"
                      data-name="Icon ionic-ios-star"
                      d="M17.79,8.567h-5.3l-1.612-4.81a.584.584,0,0,0-1.1,0L8.167,8.567H2.827a.579.579,0,0,0-.577.577.424.424,0,0,0,.011.1.554.554,0,0,0,.242.407l4.359,3.072L5.189,17.585a.579.579,0,0,0,.2.649.558.558,0,0,0,.325.141.707.707,0,0,0,.361-.13l4.255-3.032,4.255,3.032a.676.676,0,0,0,.361.13.518.518,0,0,0,.321-.141.571.571,0,0,0,.2-.649l-1.673-4.864,4.323-3.1.1-.09a.551.551,0,0,0-.425-.963Z"
              ...
              <div className=" filter_btn flex h-8 first:mt-3 mr-2">
                ...
                <input
                  type="text"
                  id="website-admin"
                  className=" rounded-r-[20px] w-[130px] bg-transparent border border-main_primary text-main_primary border-t-[2px] border-r-[2px] border-b-[2px] focus:outline-0 focus:ring-0 focus:border-main_primary placeholder:italic "
