    ...
    return (
        <>
            <div className = {`${styles.landing_main} overflow-auto w-[54%] landing_main h-full flex flex-col items-start justify-start`}>
                ...
                <p className = "text-[18px] ml-[90px] text-main_primary italic leading-loose mr-[90px] mb-[50px]">Find issues aims to provide you access to the <b>most recent created issues</b> on GitHub which is not assigned to anyone in accordance with your development language with it's advance search technique .</p>
